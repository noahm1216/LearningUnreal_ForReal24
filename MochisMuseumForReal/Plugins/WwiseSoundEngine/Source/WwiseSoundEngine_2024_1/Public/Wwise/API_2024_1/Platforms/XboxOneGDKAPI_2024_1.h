...
class FWwisePlatformAPI_2024_1_XboxOneGDK : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2024_1_XboxOneGDK);
	FWwisePlatformAPI_2024_1_XboxOneGDK() = default;
	virtual ~FWwisePlatformAPI_2024_1_XboxOneGDK() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2024_1_XboxOneGDK;
