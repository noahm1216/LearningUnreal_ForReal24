...
class FWwisePlatformAPI_2024_1_XSX : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2024_1_XSX);
	FWwisePlatformAPI_2024_1_XSX() = default;
	virtual ~FWwisePlatformAPI_2024_1_XSX() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2024_1_XSX;
