...
public class WwiseUEPlatform_2024_1_XSX : WwiseUEPlatform
{
	public WwiseUEPlatform_2024_1_XSX(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
...
public class WwiseUEPlatform_2024_1_MPX : WwiseUEPlatform_2024_1_XSX
{
	public WwiseUEPlatform_2024_1_MPX(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
}