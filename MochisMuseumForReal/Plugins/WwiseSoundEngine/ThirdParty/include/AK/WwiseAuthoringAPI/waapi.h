...
namespace ak
{
	...
	namespace wwise
	{
		...
		namespace core
		{
			namespace audio
			{
				/*! This functions creates a converted audio file. This function returns a list of messages with associated severity when errors occur. */
				...
				/*! This function changes the conversion plugin to use for converting audio files. */
