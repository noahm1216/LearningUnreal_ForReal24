...
public class ak
{
	...
	public class wwise
	{
		...
		public class core
		{
			public class audio
			{
				/// <summary>Converts audio file. This function returns error  messages with associated severity when errors occurs.</summary>
				...
				/// <summary>This function changes the conversion plugin to use in conversion</summary>
